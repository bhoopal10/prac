 ...
 */
require_once 'google-api/src/Google_Client.php';// MAKE SURE TO CHANGE THIS TO YOUR LOCATION
...
// oauth2_client_id, oauth2_client_secret, and to register your oauth2_redirect_uri.
 ...
 $client->setRedirectUri('http://localhost/prac/quickstart.php');
...
//-------------------------------------
	...
	<atom:entry xmlns:atom='http://www.w3.org/2005/Atom'
	  ...
	  <gd:name>
		 ...
		 <gd:fullName>Hello World2</gd:fullName>
	  </gd:name>
